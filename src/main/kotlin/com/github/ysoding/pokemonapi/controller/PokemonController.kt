...
import com.github.ysoding.pokemonapi.repository.PokemonListRepository
...
class PokemonController(
    @Autowired val pokemonRepo: PokemonListRepository, @Autowired val detailRepo: PokemonDetailRepository
) {
    //    TODO: 做个分页
    @GetMapping
